...
class ExerciseRepositoryTest {
	...
	@Test
	public void AddBP() {
		Exercise exercise = new Exercise("lifting", "2:00", "20:03:2023", userRepo.findById(1).get(0));
	...
	public void getExerciseByUser() {
		List<Exercise> exerciseList = exRepository.getAllByUser(userRepo.findById(1).get(0));
	...
	public void updateBloodPressureEntry() {
		...
		Exercise updatedExercise = exRepository.findById(exercise.getExerciseId()).orElse(null);
		assertNotNull(updatedExercise);
		assertEquals("lifting", updatedExercise.getExerciseName());
		assertEquals("2:00", updatedExercise.getExerciseHours());
	...
	public void deleteBloodPressureEntry() {
		...
		// get bp id and delete the exercise entry
