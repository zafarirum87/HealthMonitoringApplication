...
class BloodPressureRepositoryTest {
	...
	@Test
	public void AddBP() {
		BloodPressure bp = new BloodPressure(120, 80, 90, "20:03:2023", "02:12", userRepo.findById(1).get(0));
	...
	@Test
	public void getBloodPressureEntriesByUser() {
		List<BloodPressure> bpList = bpRepository.getAllByUser(userRepo.findById(1).get(0));
	...
	// 3)update bp
	@Test
	public void updateBloodPressureEntry() {
		// Create a new BloodPressure entry
		BloodPressure bp = new BloodPressure(120, 80, 90, "20:03:2023", "02:12", userRepo.findById(1).get(0));
		bpRepository.save(bp);

		// Update the BloodPressure entry
		bp.setSystolic(130);
		bp.setDiastolic(85);
		bpRepository.save(bp);

		// Verify that the update was successful
		BloodPressure updatedBp = bpRepository.findById(bp.getBloodPressureId()).orElse(null);
		assertNotNull(updatedBp);
		assertEquals(130, updatedBp.getSystolic());
		assertEquals(85, updatedBp.getDiastolic());
	}

	// 4)delete bp entry
	@Test
	public void deleteBloodPressureEntry() {
		// Create a new BloodPressure entry
		BloodPressure bp = new BloodPressure(120, 80, 90, "20:03:2023", "02:12", userRepo.findById(1).get(0));
		bpRepository.save(bp);

		// get bp id and delete the BloodPressure entry
		Long id = bp.getBloodPressureId();
